<div class="questions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Resp_Correc');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $question['Question']['Contenido']; ?>&nbsp;</td>
		<td><?php echo $question['Question']['Resp_Correc']; ?>&nbsp;</td>
		<td><?php echo $question['Question']['puntuacion']; ?>&nbsp;</td>
		<td><?php echo $question['Question']['profesor']; ?>&nbsp;</td>
		<td><?php echo $question['Question']['Fecha']; ?>&nbsp;</td>
		<td class="actions">
